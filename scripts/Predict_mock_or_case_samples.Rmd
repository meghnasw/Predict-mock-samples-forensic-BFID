...
dada2_obj <- load("01_DADA2/seqtab_nochim.rdata")
seqtab <- get(dada2_obj)
#Save the ASV abundance file
seqtab.nochim_t <- as.data.frame(t(seqtab))
...
#Save the sequences
uniquesToFasta(seqtab, fout='01_DADA2/rep-seqs.fna', ids=colnames(seqtab))
```
...
The classifier was trained using QIIME2. Training data consists of: - Data from V3V4, V4 and V4V5 regions - Data from 7 body fluids/tissues: Fecal, Saliva, Semen, Skin-penile, Skin-hand, Urine and Vaginal swab. Vaginal swab samples comprise data from vaginal fluid and menstrual blood samples. - Total 366 samples - The classifier file is in Reference_files/sample_estimator.qza
